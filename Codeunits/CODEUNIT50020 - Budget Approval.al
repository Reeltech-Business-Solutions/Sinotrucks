codeunit 50020 "Budget Approval"
{
    SingleInstance = true;
    ...
    // VoucherLineRec: Record "Voucher Line";to
    begin
        ...
        //   //to  PaymentVoucher.Reset();
        //   //to  PaymentVoucher.SetRange("No.", PaymentHeader."No.");
        ...
        //     //                     DimensionTemporary."Dimension Code" := Dimension.Code;
        //     //                     DimensionTemporary."Dimension name" := Dimension."Dimension Code";
        //     //                     //to     DimensionTemporary."Account No." := VoucherLine."Account No.";
        //     //                     DimensionTemporary."Global Dimension No" := Dimension."Global Dimension No.";
        //     //                     DimensionTemporary.Amount := AccountRec;
        //     //                     DimensionTemporary.INSERT;
        //     //                 END;
        ...
        //     //         // to    IF VoucherLine."Account No." <> '' THEN BEGIN
        //     //         //         VoucherLineRec.RESET;
        //     //         //         VoucherLineRec.SETRANGE("Document No.", VoucherLine."Document No.");
        //     //         //    //to     VoucherLineRec.SETRANGE("Account No.", VoucherLine."Account No.");
        ...
        //     //         //         AccountTemporary.RESET;
        //     //         //  //to       AccountTemporary.SETRANGE("Account No.", VoucherLine."Account No.");
        //     //         //         IF NOT AccountTemporary.FINDFIRST THEN BEGIN
        //     //         //             AccountTemporary.INIT;
        //     //         //       //to      AccountTemporary."Account No." := VoucherLine."Account No.";
