table 50119 "Voucher Header"
{
    ...
    fields
    {
        ...
        field(24; "External Document No."; Code[20])
        {
            ...
            //to     PVHeader: record "Posted Voucher Header";
            begin
                ...
                //to     PVheader.Setrange(PVheader."External Document No.", "External Document No.");
                //to     if PVheader.find('-') then
                Error('Document No. %1 Already exist', "External Document No.");
            end;
        ...
        field(60013; "Leave Payment"; boolean)
        {
        }
