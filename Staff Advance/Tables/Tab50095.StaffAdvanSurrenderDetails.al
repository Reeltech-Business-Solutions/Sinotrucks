table 50095 "Staff Advan Surrender Details"
{
        ...
        field(50005; "Applies-to Doc. No."; Code[20])
        {
            ...
            begin
                ...
                if "Account Type" = "Account Type"::"Employee" then begin
                    ...
                    //to     // OK := ApplyEmployeeEntries.RunModal = ACTION::LookupOK;
    ...
    begin
        if staffRetHeader.SystemId <> "Header Id" then
            staffRetHeader.GetBySystemId("Header Id");
    end;

    var
        GLAcc: Record "G/L Account";

        staffRetHeader: Record "Staff Advanc Surrender Header";
        ...
        //to   ApplyEmployeeEntries: Page "Apply Employee Entries2";
