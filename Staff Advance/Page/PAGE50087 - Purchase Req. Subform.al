        ...
        area(content)
        {
            repeater(Control1)
            {
                ...
                */
                ...
                field("Serv. Quote No"; Rec."Serv. Quote No")
                {
                    ApplicationArea = All;
                    Editable = false;
                }
            ...
            group("&Line")
            {
                ...
                group("Item Availability by")
                {
                    ...
                    action("Event")
                    {
                        ...
                        trigger OnAction()
                        var
                            showItem: Codeunit "Purch. Availability Mgt.";
                        begin
                            showItem.ShowItemAvailabilityFromPurchLine(Rec, "Item Availability Type"::"Event")
                        end;
                    }
                    action(Period)
                    {
                        ...
                        var
                            showItem: codeunit "Purch. Availability Mgt.";
                        begin
                            showItem.ShowItemAvailabilityFromPurchLine(Rec, "Item Availability Type"::Period);
                        end;
                    }
                    action(Variant)
                    {
                        ...
                        var
                            showItem: codeunit "Purch. Availability Mgt.";
                        begin
                            showItem.ShowItemAvailabilityFromPurchLine(Rec, "Item Availability Type"::Variant);
                        end;
                    }
                    action(Location)
                    {
                        ...
                        var
                            showItem: codeunit "Purch. Availability Mgt.";
                        begin
                            showItem.ShowItemAvailabilityFromPurchLine(Rec, "Item Availability Type"::Location);
                        end;
                    }
                    action("BOM Level")
                    {
                        ...
                        var
                            showItem: codeunit "Purch. Availability Mgt.";
                        begin
                            showItem.ShowItemAvailabilityFromPurchLine(Rec, "Item Availability Type"::BOM);
                        end;
