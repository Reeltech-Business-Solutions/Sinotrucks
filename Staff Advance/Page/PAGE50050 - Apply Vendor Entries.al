page 50050 "Apply Vendor Entries2"
{
                    ...
                    case ApplnType of
                        ...
                        ApplnType::"Applies-to ID":
                            begin
                                ...
                                // HandleChosenEntries(2,to
                                // PVLine.Amount,
                                // PVLine."Currency Code",
                                // PVLine."Posting Date");to
    ...
    //to  procedure SetPVLine2(NewPVLine: Record "Voucher Line"; var NewVendLedgEntry: Record "Vendor Ledger Entry"; ApplnTypeSelect: Integer)
    var
    ...
    begin
        ...
        //to   ApplyingAmount := PVLine.Amount;
