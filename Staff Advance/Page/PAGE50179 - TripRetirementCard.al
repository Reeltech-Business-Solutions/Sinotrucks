        ...
        area(content)
        {
            group(General)
            {
                ...
                field("Global Dimension 1 Code"; Rec."Global Dimension 1 Code")
                {
                    ...
                    trigger OnValidate()
                    var
                        //to   DimensName: Codeunit "Posting Check FP1";
                        DimName1: Code[20];
                    begin
                        //to     DimName1 := DimensName.GetDimensionName(Rec."Global Dimension 1 Code", 1);
                    end;
                }
                ...
                field("Shortcut Dimension 2 Code"; Rec."Shortcut Dimension 2 Code")
                {
                    ...
                    var
                        ...
                        DimName2: Code[100];
                    begin
                        //to       DimName2 := DimensName.GetDimensionName(Rec."Shortcut Dimension 2 Code", 2);
        ...
        area(processing)
        {
            ...
            group("Request Approval")
            {
                ...
                action("Send Approval Request")
                {
                    ...
                    //to      // BudgetCheck: Codeunit "Posting Check FP1";
                    begin
                ...
                action("Cancel Approval Request")
                {
                    ...
                    //to       ApprovalMgt: Codeunit "Approval Mgmt. ExtCal";
                    begin
                        //to     ApprovalMgt.OnCancelAdvanceSurrenderForApproval(Rec);
                    end;
                }
