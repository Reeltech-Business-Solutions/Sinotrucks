table 54546 "prSalary Card TEMP"
{
    fields
    {
        ...
        {
            CalcFormula = Sum("prPeriod Transactions".Amount WHERE("Group Order"=FILTER(1), "Sub Group Order"=FILTER(2), "Employee Code"=FIELD("Employee Code")));
            Editable = false;
            FieldClass = FlowField;
        }
        ...
        {
            CalcFormula = Sum("prPeriod Transactions".Amount WHERE("Transaction Code"=FILTER('637'), "Employee Code"=FIELD("Employee Code")));
            FieldClass = FlowField;
        }
