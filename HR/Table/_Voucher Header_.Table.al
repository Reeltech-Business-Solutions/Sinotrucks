...
//                         GLSetup.GET;
//                         NSeriesMgt.TestManual(GetNoSeriesCode);
//                         "No. Series" := '';
//                     END;
//             end;
//         }
...
//         {
//             TableRelation = IF ("Account Type" = CONST("Bank Account"), "Voucher Type" = FILTER(CPV | PettyCash)) "Bank Account"."No." WHERE(Cash = CONST(true))
...
//         {
//             CalcFormula = Sum("Voucher Line".Amount WHERE("Voucher Type" = FIELD("Voucher Type"), "Document No." = FIELD("No.")));
//             Editable = false;
//             FieldClass = FlowField;
//         }
//         field(7; "Amount (LCY)"; Decimal)
//         {
//             CalcFormula = Sum("Voucher Line"."Amount (LCY)" WHERE("Voucher Type" = FIELD("Voucher Type"), "Document No." = FIELD("No.")));
//             Editable = false;
//             FieldClass = FlowField;
//         }
...
//                     IF ("Currency Code" <> xRec."Currency Code") OR ("Posting Date" <> xRec."Posting Date") OR (CurrFieldNo = FIELDNO(Narration)) OR ("Currency Factor" = 0) THEN BEGIN
...
//                 if Vheader.find('-') then Error('Document No. %1 Already exist', "External Document No.");
//                 PVheader.Setrange(PVheader."External Document No.", "External Document No.");
//                 if PVheader.find('-') then Error('Document No. %1 Already exist', "External Document No.");
//             end;
//         }
...
//         {
//             CalcFormula = Sum("Voucher Line"."Amount (LCY)" WHERE("Voucher Type" = FIELD("Voucher Type"), "Document No." = FIELD("No."), "Amount (LCY)" = FILTER(> 0)));
//             Editable = false;
//             FieldClass = FlowField;
//         }
...
//         {
//             CalcFormula = Lookup("Voucher Line"."Account No." WHERE("Voucher Type" = FIELD("Voucher Type"), "Document No." = FIELD("No."), "Account Type" = FILTER(Customer)));
//             FieldClass = FlowField;
//         }
//         field(50006; "Customer Name"; Text[50])
//         {
//             CalcFormula = Lookup("Voucher Line"."Account Name" WHERE("Voucher Type" = FIELD("Voucher Type"), "Document No." = FIELD("No."), "Account Type" = FILTER(Customer)));
//             FieldClass = FlowField;
//         }
...
//         IF VoucherLine.FIND('-') THEN VoucherLine.DELETEALL;
//     end;
...
//             if NSeriesMgt.AreRelated(GetNoSeriesCode, xRec."No.") then
...
//                             IF (RespCenter."Posted JV Nos." <> '') THEN //NoSeriesMgt.SetDefaultSeries("Posting No. Series", RespCenter."Posted JV Nos.");
//                                 "Posting No. Series" := NSeriesMgt.GetNextNo(RespCenter."Posted JV Nos.");
//                         END
//                         ELSE
...
//                     IF "Posting No. Series" = '' THEN BEGIN
//                         IF RespCenter.GET("Responsibility Center") THEN BEGIN
//                             IF (RespCenter."Posted CPV Nos." <> '') THEN// NoSeriesMgt.SetDefaultSeries("Posting No. Series", RespCenter."Posted CPV Nos.");
//                                 "Posting No. Series" := NSeriesMgt.GetNextNo(RespCenter."Posted CPV Nos.");
//                         END
//                         ELSE
//                             "Posting No. Series" := NSeriesMgt.GetNextNo(RespCenter."Posted CPV Nos.");
...
//                     IF "Posting No. Series" = '' THEN BEGIN
//                         IF RespCenter.GET("Responsibility Center") THEN BEGIN
//                             IF (RespCenter."Posted CRV Nos." <> '') THEN// NoSeriesMgt.SetDefaultSeries("Posting No. Series", RespCenter."Posted CRV Nos.");
//                                 "Posting No. Series" := NSeriesMgt.GetNextNo(RespCenter."Posted CRV Nos.");
//                         END
//                         ELSE
...
//                     IF "Posting No. Series" = '' THEN BEGIN
//                         IF RespCenter.GET("Responsibility Center") THEN BEGIN
//                             IF (RespCenter."Posted BPV Nos." <> '') THEN //NoSeriesMgt.SetDefaultSeries("Posting No. Series", RespCenter."Posted BPV Nos.");
//                                 "Posting No. Series" := NSeriesMgt.GetNextNo(RespCenter."Posted BPV Nos.");
//                         END
//                         ELSE
...
//                     IF "Posting No. Series" = '' THEN BEGIN
//                         IF RespCenter.GET("Responsibility Center") THEN BEGIN
//                             IF (RespCenter."Posted Petty Cash Nos" <> '') THEN// NoSeriesMgt.SetDefaultSeries("Posting No. Series", RespCenter."Posted Petty Cash Nos");
//                                 "Posting No. Series" := NSeriesMgt.GetNextNo(RespCenter."Posted Petty Cash Nos");
//                         END
//                         ELSE
...
//         if NSeriesMgt.LookupRelatedNoSeries(GetNoSeriesCode, "No. Series") then begin
//             GLSetup.GET;
//             TestNoSeries;
//             // NoSeriesMgt.SetSeries("No.");
//             NSeriesMgt.GetNextNo("No.");
//             EXIT(TRUE);
//         END;
//     end;
...
//             "Voucher Type"::Contra: //GLSetup.TESTFIELD(GLSetup."Contra Voucher Nos.");
//                                     //"Voucher Type":: PettyCash:
...
//         "Dimension Set ID" := DimMgt.EditDimensionSet("Dimension Set ID", STRSUBSTNO('%1 %2', "Voucher Type", "No."), "Shortcut Dimension 1 Code", "Shortcut Dimension 2 Code");
//         IF OldDimSetID <> "Dimension Set ID" THEN BEGIN
//             MODIFY;
//             IF VoucherLinesExist THEN UpdateAllLineDim("Dimension Set ID", OldDimSetID);
//         END;
//     end;
...
//                     DimMgt.UpdateGlobalDimFromDimSetID(VoucherLine."Dimension Set ID", VoucherLine."Shortcut Dimension 1 Code", VoucherLine."Shortcut Dimension 2 Code");
//                     VoucherLine.MODIFY;
//                 END;
//             UNTIL VoucherLine.NEXT = 0;
//     end;
