table 54600 "HR E-Mail Parameters"
{
    fields
    {
        field(1; "Associate With"; Option)
        {
            ...
            OptionMembers = "Vacancy Advertisements", "Interview Invitations", General, "Training Application", "Disciplinary Commitee", "Query", Communication, Birthday;
        }
