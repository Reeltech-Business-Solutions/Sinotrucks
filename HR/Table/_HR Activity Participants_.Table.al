table 54586 "HR Activity Participants"
{
    ...
    var HRCompanyActivities: Record "HR Company Activities";
    ...
    begin
        case "Table ID" of DATABASE::"Sales Header": begin
            if not SalesHeader.Get("Document Type", "Document No.")then exit;
            case "Document Type" of "Document Type"::"Company Activity": PAGE.Run(PAGE::"Sales Quote", SalesHeader);
            /*
                "Document Type"::"1":
        ...
        DATABASE::"Purchase Header": begin
            ...
            case "Document Type" of "Document Type"::"Company Activity": PAGE.Run(PAGE::"Purchase Quote", PurchHeader);
            /*
                "Document Type"::"1":
