report 54777 "Fin Posting Location CONTRACT"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("prPeriod Transactions"; "prPeriod Transactions")
        {
            ...
            begin
                ...
                if prTrans.FindFirst then repeat PsgAmt+=prTrans.Amount;
                ...
                if("prPeriod Transactions"."Transaction Code" = 'GPAY') or ("prPeriod Transactions"."Transaction Code" = 'NPAY')then TotalDeptAmount:=TotalDeptAmount - PsgAmt;
            end;
