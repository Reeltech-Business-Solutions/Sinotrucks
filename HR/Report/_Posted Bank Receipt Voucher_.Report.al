// report 54987 "Posted Bank Receipt Voucher"
// {
//     DefaultLayout = RDLC;
...
//             DataItemTableView = SORTING("Voucher Type", "No.")WHERE("Voucher Type"=FILTER(BRV));
...
//                 DataItemTableView = SORTING("Voucher Type", "Document No.", "Line No.")WHERE("Voucher Type"=FILTER(BRV));
