page 50267 "HR Approved Leave"
{
    ApplicationArea = All;
    Caption = 'HR Approved Leave';
    PageType = Card;
            ...
            group("Leave Details")
            {
                ...
                field("Days Applied"; Rec."Days Applied")
                {
                    ...
                    begin
                        ...
                        if (LeaveBalance = 0) and (Rec."Leave Type" <> 'SICK') and (Rec."Leave Type" <> 'EXAM') then begin
                            //LeaveApp.SetFilter(LeaveApp."Leave Type", '%1|%2', 'ANNUAL', 'INTERMITENT');
                        ...
                        if ((rec."Days Applied" > LeaveBalance) and (HREmp."Annual Exam Leave" < Rec."Days Applied")) and (Rec."Leave Type" <> 'SICK') and (Rec."Leave Type" <> 'EXAM') then begin
                            // LeaveApp.SetFilter(LeaveApp."Leave Type", '%1|%2', 'ANNUAL', 'INTERMITENT');
                            Error('Days applied cannot exceed your balance/maximum annual days');
                        end;
                        HRSetup.Get;
