// report 54985 "Petty Cash Voucher"
// {
//     DefaultLayout = RDLC;
...
//             DataItemTableView = SORTING("Voucher Type", "No.")WHERE("Voucher Type"=FILTER(PettyCash));
...
//                 DataItemTableView = SORTING("Voucher Type", "Document No.", "Line No.")WHERE("Voucher Type"=FILTER(PettyCash));
...
//                             IF NOT(VoucherLine."Line No." = VoucherLineNo)THEN CurrReport.BREAK;
