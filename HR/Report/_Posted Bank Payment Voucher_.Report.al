// report 54986 "Posted Bank Payment Voucher"
// {
//     DefaultLayout = RDLC;
...
//             DataItemTableView = SORTING("Voucher Type", "No.")WHERE("Voucher Type"=FILTER(BPV));
...
//                 DataItemTableView = SORTING("Voucher Type", "Document No.", "Line No.")WHERE("Voucher Type"=FILTER(BPV));
