            ...
            begin
                ...
                if Trans.Find('-')then begin
                    repeat Trans.CalcFields("Curr. Amount");
                        ...
                        if Trans."Transaction Category" = Trans."Transaction Category"::Pension then begin
                            ...
                            begin
                                ...
                                if EmployerDed.FindLast then cValue[21]:=EmployerDed.Amount;
                            end;
                        end;
                        //Surcharge
                        cHeader[15]:='Car Loan'; //PKK'Surcharge';
                        if Trans."Transaction Category" = Trans."Transaction Category"::"Car Loan" then begin
                    ...
                    begin
                        ...
                        if PeriodTrans.FindFirst then cValue[20]:=PeriodTrans.Amount;
                    end;
                        //Net Pay
                        cHeader[22]:='Net Pay';
