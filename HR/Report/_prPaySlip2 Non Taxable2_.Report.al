report 54619 "prPaySlip2 Non Taxable2"
{
    DefaultLayout = RDLC;
            ...
            dataitem("prSalary Card"; "prSalary Card")
            {
                ...
                begin
                    ...
                    *****************************************************************************************************/
                    ...
                    if PeriodTrans.Find('-')then repeat Gpay:=StatutoryAmt + PeriodTrans.Amount;
                    ...
                    Index:=1;
                    strGrpText:='';
                    if PeriodTrans.Find('-')then repeat PeriodTrans.CalcFields(Exclude); //dennis to filter our company deductions
                            if(PeriodTrans."Transaction Code" <> 'TXCHRG')then begin //PKK
                                ...
                                if(strGrpText <> PeriodTrans."Group Text")then begin
                                    ...
                                    if PeriodTrans."Transaction Code" = 'TOT-DED' then Evaluate(TransAmt[ColumnNo, Index], Format(Round(PeriodTrans.Amount + StatutoryAmt, 0.01)))
                                    else
