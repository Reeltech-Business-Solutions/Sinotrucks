report 54662 "Employee Earnings Summary"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("prTransaction Codes"; "prTransaction Codes")
        {
            ...
            begin
                if GetFilter("prTransaction Codes"."Employee Code Filter") = '' then Error('You must specify Employee Code Filter.');
                EmployeeName:='';
                if HREmployee.Get(GetFilter("prTransaction Codes"."Employee Code Filter"))then EmployeeName:=HREmployee."First Name" + ' ' + HREmployee."Middle Name" + ' ' + HREmployee."Last Name";
