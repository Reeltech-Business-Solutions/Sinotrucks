// report 54988 "Posted Cash Payment Voucher"
// {
//     DefaultLayout = RDLC;
...
//             DataItemTableView = SORTING("Voucher Type", "No.")WHERE("Voucher Type"=FILTER(CPV));
...
//                 DataItemTableView = SORTING("Voucher Type", "Document No.", "Line No.")WHERE("Voucher Type"=FILTER(CPV));
