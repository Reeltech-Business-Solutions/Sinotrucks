// report 54989 "Posted Cash Receipt Voucher"
// {
//     DefaultLayout = RDLC;
...
//             DataItemTableView = SORTING("Voucher Type", "No.")WHERE("Voucher Type"=FILTER(CRV));
...
//                 DataItemTableView = SORTING("Voucher Type", "Document No.", "Line No.")WHERE("Voucher Type"=FILTER(CRV), "Account No."=FILTER(<>''));
...
//                             IF NOT(PostedVoucherLine."Line No." = VoucherLineNo)THEN CurrReport.BREAK;
...
//                 END;
//                 CASE "Voucher Type" OF "Voucher Type"::CRV: VoucherName:=Text001;
//                 "Voucher Type"::CPV: VoucherName:=Text002;
//                 "Voucher Type"::BRV: VoucherName:=Text003;
//                 "Voucher Type"::BPV: VoucherName:=Text004;
//                 "Voucher Type"::JV: VoucherName:=Text005;
//                 END;
//                 PageLoop:=PageLoop - 1;
