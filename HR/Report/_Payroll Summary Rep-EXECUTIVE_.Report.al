report 54766 "Payroll Summary Rep-EXECUTIVE"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("prPeriod Transactions"; "prPeriod Transactions")
        {
            ...
            begin
                ...
                if prPeriodTransactions.FindFirst then repeat nonTax+=prPeriodTransactions.Amount;
                    until prPeriodTransactions.Next = 0;
                if "prPeriod Transactions"."Transaction Code" = 'NPAY' then amt:="prPeriod Transactions".Amount - nonTax
                else if "prPeriod Transactions"."Transaction Code" = 'GPAY' then amt:="prPeriod Transactions".Amount - nonTax
                    else
