...
//             DataItemTableView = SORTING("Voucher Type", "No.")WHERE("Voucher Type"=FILTER(JV));
...
//                 DataItemTableView = SORTING("Voucher Type", "Document No.", "Line No.")WHERE("Voucher Type"=FILTER(JV));
