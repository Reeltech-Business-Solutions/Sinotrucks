report 54618 "prCoop remmitance"
{
    DefaultLayout = RDLC;
        ...
        dataitem("prSalary Card"; "prSalary Card")
        {
            ...
            begin
                ...
                if transcode.Find('-')then begin
                    repeat PeriodTrans.SetRange(PeriodTrans."Employee Code", "prSalary Card"."Employee Code");
                        ...
                        if PeriodTrans.Find('-')then begin
                            ...
                            if PeriodTrans.Find('-')then CoopLoan:=CoopLoan + Abs(PeriodTrans.Amount);
                            //
                            Index:=Index + 1;
                ...
                if(CoopLoan = 0)then CurrReport.Skip;
                COUNTER:=COUNTER + 1;
