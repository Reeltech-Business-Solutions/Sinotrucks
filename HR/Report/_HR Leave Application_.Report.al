report 54692 "HR Leave Application"
{
    DefaultLayout = RDLC;
    RDLCLayout = './HRLeaveApplication.rdl';
    ...
    dataset
    {
        dataitem("HR Leave Application"; "HR Leave Application")
        {
            ...
            column(RelieverName_HRLeaveApplication; "HR Leave Application"."Relievers Name")
            {
                IncludeCaption = true;
            }
            ...
            column(JobTittle_HRLeaveApplication; "HR Leave Application"."Job Title")
            {
                IncludeCaption = true;
            }
