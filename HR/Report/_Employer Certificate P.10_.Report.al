report 54629 "Employer Certificate P.10"
{
    //     DefaultLayout = RDLC;
    ...
    //             begin
    //                 NoRun:=NoRun + 1;
    //                 if NoRun > 1 then CurrReport.Break;
    //             end;
    //         }
    //     }
    //     requestpage
    ...
    //     begin
    //         NoRun:=0;
    //         if StringDate = 0D then Error('Enter the Start Date');
    //         if EndDate = 0D then Error('Enter the End Date');
    //         CompanySetup.Get;
    ...
    //                     if Employees.Gender = Employees.Gender::Male then A:=A + 1
    //                     else
    //                         AF:=AF + 1;
    //                 end;
    ...
    //                 Employees.SetRange(Employees."No.", EmployeeLedger."Employee Code");
    //                 if Employees.Find('-')then begin
    //                     if Employees.Gender = Employees.Gender::Male then B:=B + 1
    //                     else
    //                         BF:=BF + 1;
    //                 end;
    //             until EmployeeLedger.Next = 0;
    ...
    //                 Employees.SetRange(Employees."No.", EmployeeLedger."Employee Code");
    //                 if Employees.Find('-')then begin
    //                     if Employees.Gender = Employees.Gender::Male then C:=C + 1
    //                     else
    //                         CF:=CF + 1;
    //                 end;
    //             until EmployeeLedger.Next = 0;
    ...
    //                 Employees.SetRange(Employees."No.", EmployeeLedger."Employee Code");
    //                 if Employees.Find('-')then begin
    //                     if Employees.Gender = Employees.Gender::Male then D:=D + 1
    //                     else
    //                         DF:=DF + 1;
    //                 end;
    //             until EmployeeLedger.Next = 0;
    ...
    //                 Employees.SetRange(Employees."No.", EmployeeLedger."Employee Code");
    //                 if Employees.Find('-')then begin
    //                     if Employees.Gender = Employees.Gender::Male then E:=E + 1
    //                     else
    //                         EF:=EF + 1;
    //                 end;
    //             until EmployeeLedger.Next = 0;
    ...
    //                 Employees.SetRange(Employees."No.", EmployeeLedger."Employee Code");
    //                 if Employees.Find('-')then begin
    //                     if Employees.Gender = Employees.Gender::Male then F:=F + 1
    //                     else
    //                         FF:=FF + 1;
    //                 end;
    //             until EmployeeLedger.Next = 0;
