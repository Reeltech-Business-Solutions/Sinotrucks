report 54526 "HR Employee Entitlement2"
{
    DefaultLayout = RDLC;
            ...
            dataitem(EmployeeAllowan; "prEmployee Transactions")
            {
                ...
                begin
                    ...
                    if TransCode.Get(EmployeeAllowan."Transaction Code") then begin
                        ...
                        if TransCode."Transaction Code" = 'PENS-INC' then EmployeeAllw := 0;
                    end;
                end;
                ...
                begin
                    ...
                    if TransCode.Get(AnnualPay."Transaction Code") then begin
                        if TransCode."Leave Allowance" then begin
                            if ("HR Employee Exit Interviews"."Leave Allowance Paid") or (TransCode.Passage) then AnnualAmount := 0;
                        end;
                    end;
                end;
