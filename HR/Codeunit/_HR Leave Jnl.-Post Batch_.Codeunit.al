codeunit 54505 "HR Leave Jnl.-Post Batch"
{
    ...
    begin
        with InsuranceJnlLine do begin
            ...
            repeat
                ...
                if not ("Leave Period" = '') and (InsuranceJnlBatch."No. Series" <> '') and ("Document No." <> LastDocNo2) then TestField("Document No.", NoSeriesMgt.GetNextNo(InsuranceJnlBatch."No. Series", "Posting Date", false));
                LastDocNo2 := "Document No.";
                if "Posting No. Series" = '' then
                    "Posting No. Series" := InsuranceJnlBatch."No. Series"
                else if not ("Leave Period" = '') then
            ...
            if InsuranceRegNo <> 0 then begin
                ...
                if InsuranceJnlLine3.Find('-') then
                    repeat //JnlLineDim.SETRANGE("Journal Line No.",InsuranceJnlLine3."Line No.");
            ...
            if InsuranceJnlBatch."No. Series" <> '' then NoseriesBatch.SaveState();
