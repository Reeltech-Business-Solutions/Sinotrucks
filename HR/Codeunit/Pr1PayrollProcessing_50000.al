    ...
    begin
        ...
        with prPeriodTransactions do begin
            ...
            if prSalCard.Get(EmpCode) then begin
                ...
                "Payroll Posting Group" := prSalCard."Posting Group";//Lateef 20102021
    ...
    begin
        ...
        if HREmp.FindFirst then begin
            ...
            if prEmployees.Find('-') then begin
                ...
                prEmployees."Department Code" := HREmp."Shorcut Dimension 7";
                ...
                prEmployees."Medical Scheme Name" := HREmp."Medical Scheme Name #2";
                ...
                prEmployees."Location/Division Code" := HREmp."Global Dimension 2";
                // prEmployees.Validate(prEmployees."Location/Division Code");
                // DimVal.Reset;
                // DimVal.SetRange(DimVal."Global Dimension No.", 1);
                // DimVal.SetRange(DimVal.Code,HREmp."Global Dimension 1");
                // if DimVal.FindFirst then
                ...
                prEmployees."Payroll Code" := HREmp."No.";
                //prEmployees."Department Code":=HREmp."Global Dimension 2 Code";
                prEmployees."Location/Division Code" := HREmp."Global Dimension 1";
                //prEmployees.Validate(prEmployees."Location/Division Code");
