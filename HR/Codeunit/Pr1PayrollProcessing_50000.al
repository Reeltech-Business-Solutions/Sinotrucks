...
//                     if PayeTillDate = 0 then  curTransAmount := curPAYE
//                         else curTransAmount:=PayeTillDate;
...
//                         end else
//                         begin
//                             if (prTransactionCodes."Transaction Category" =prTransactionCodes."Transaction Category"::Advance) then
//                             begin TGroup := 'DEDUCTIONS'; TGroupOrder := 8; TSubGroupOrder := 5 end
//                             else
//                             begin TGroup := 'DEDUCTIONS'; TGroupOrder := 8; TSubGroupOrder := 0; end;
//                         end;
...
//         startmonth: Integer;
//         startYear: Integer;
//         "prEmployee P9 Info"@1102756008 : Record 50010;
//         P9BasicPay: Decimal;
//         P9taxablePay: Decimal;
//         P9PAYE: Decimal;
...
//         StartDate: Date;
//         "prSalary Arrears"@1102756009 : Record 50006;
//     begin
