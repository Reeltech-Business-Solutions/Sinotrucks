...
//     UsageCategory = Lists;
//     SourceTableView = where("Is Vehicle" = const(true));
...
//                         //     NoSeriesMgt.TestManual(GeneralLedgerSetup."Rent Code Nos.");
//                         //     xRec."No." := '';
...
//                     ToolTip = 'Specified the make of the vehicle';
//                 }
