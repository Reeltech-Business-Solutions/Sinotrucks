...
//                     ToolTip = 'Specifies the make of Vehicle.';

//                     trigger OnValidate()
//                     begin
//                         //IsMakeVisible := FormatAddress.UseCounty("Country/Region Code");
//                     end;
//                 }
//                 field(PlateNumber; Rec."Plate Number")
//                 {
//                     ApplicationArea = All;
//                     Caption = 'Plate Number';
//                     ToolTip = 'Specified the plate number of the vehicle';
//                 }
//                 field(DriversName; Rec."Drivers Name")
//                 {
//                     ApplicationArea = All;
//                     Caption = 'Drivers Name';
//                     ToolTip = 'Specifies Drivers Name';
...
//                     ToolTip = 'Specifies Drivers Phone Number';
//                 }
...
//                     ToolTip = '';
//                 }
//                 field(Isvehicle; Rec."IS VEHICLE")
//                 {
//                     ApplicationArea = All;
//                     Caption = 'Comments';
//                     ToolTip = '';
...
//             Rec.Validate(Rec."FA Posting Group", FASubclass."Default FA Posting Group");
