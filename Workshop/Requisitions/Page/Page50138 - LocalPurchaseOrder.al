page 50138 "Local Purchase Order"
{
        ...
        area(content)
        {
            group(General)
            {
                ...
                field("Service Quote"; Rec."Service Quote")
                {
                    ...
                    begin
                        ServiceQte.Reset();
                        ServiceQte.SetRange("No.", Rec."Service Quote");
                        if ServiceQte.FindFirst() then begin
                            ServiceQtePg.SetTableView(ServiceQte);
                            ServiceQtePg.Run();
                        end;
    ...
    begin
        ...
        if PurchLine.get(rec."Document Type", rec."No.") then begin
            Rec."Service Quote" := PurchLine."Service Quote No.";
            rec.Modify();
        end;
    end;
    ...
    begin
        ...
        if Rec.get(rec."Document Type", rec."No.") then begin
