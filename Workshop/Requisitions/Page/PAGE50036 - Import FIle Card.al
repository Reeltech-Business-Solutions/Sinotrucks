page 50036 "Import File Card"
{
    ...
    begin
        ...
        if Rec."No." = '' then
            PurchSetup.GET;
        PurchSetup.TESTFIELD(PurchSetup."Import Vendor");
        Rec."No. Series" := PurchSetup."Import Vendor";
        if NoSeries.AreRelated(PurchSetup."Import Vendor", xRec."No. Series") then
