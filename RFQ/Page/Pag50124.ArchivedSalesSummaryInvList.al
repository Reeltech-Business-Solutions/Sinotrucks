page 50124 "Archived Sales SummaryInvList"
{
    ApplicationArea = All;
    Caption = 'Archived Sales Summary Invoice List';
    PageType = List;
    SourceTable = "Sales Header";
    UsageCategory = Lists;
    CardPageID = "Archived Sales Summary Inv";
    Editable = false;
    RefreshOnActivate = true;
    SourceTableView = where("Document Type" = const(Invoice), "Manual Archive" = const(true));
