page 50110 "Summary Sales Invoice List"
{
    ApplicationArea = All;
    Caption = 'Summary Sales Invoice List';
    PageType = List;
    SourceTable = "Sales Header";
    UsageCategory = Lists;
    CardPageID = "Summary Sales Invoice";
    DataCaptionFields = "Sell-to Customer No.";
    Editable = false;
    RefreshOnActivate = true;
    SourceTableView = where("Document Type" = const(Invoice), "Summary Invoice" = const(true), "Manual Archive" = const(false));
    ...
    begin
        ...
        rec.SetFilter(Rec."Summary Invoice", '%1', true);
    end;
